...
OUT_PATH = Path(
    r"C:\Users\user\Desktop\ADPAR-final-project\adc\live_human_detector_v1_bgsub_fixedbar_60s_200ms_Raw_0.bin"
)
...
def udp_receiver_worker():
    print("=== DCA1000 live human detector V1: BG subtraction + fixed heatmap bar ===")
...
def run_plot():
    ...
    ax.set_title("Human Detector V1: BG-subtracted Range-Doppler, fixed magnitude bar")
