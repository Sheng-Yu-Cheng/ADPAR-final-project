...
MIN_COMPONENT_ENERGY_DB_OVER_NOISE = 3.0
...
# V5A mode:
# Detect hovering / up-down drone as a compact background-subtracted residual.
# This version includes near-zero Doppler bins by setting MIN_ABS_VELOCITY_MPS = 0.00.
COMPACT_SIGNAL_VERSION = True
...
DRONE_HOVER_MIN_PEAK_DB = 88.0
DRONE_HOVER_MIN_TOP10_DB = 84.0
DRONE_HOVER_MAX_ACTIVE_BINS = 18
DRONE_HOVER_MAX_RANGE_SPREAD_M = 0.22
DRONE_HOVER_MAX_VELOCITY_SPREAD_MPS = 0.30
...
OUT_PATH = Path(
    r"C:\Users\user\Desktop\ADPAR-final-project\adc\live_event_classifier_v5a_compact_hover_signal_60s_200ms_Raw_0.bin"
)
...
def udp_receiver_worker():
    print("=== DCA1000 live event classifier V5A: compact hover/up-down drone signal ===")
    ...
    print("  V5A compact-signal mode: near-zero Doppler is included.")
    print("  This targets hovering / up-down drone as a compact residual after BG subtraction.")
...
def run_plot():
    ...
    ax.set_title("Event Classifier V5A: compact hover/up-down drone signal")
